      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
              <a href="loginedit.php">Sign out</a>
            </a>
      </div>
    </nav>
  </header>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form enctype="multipart/form-data" method="post" action="actiontambahproduk.php">
                ...
                <option>Pilih</optiom>
			              ...
			              while($ulang=mysqli_fetch_array($query))
				            {
				              echo "<option value=".$ulang['idMerk'].">" .$ulang['namaMerk']."</option>";
				            }
				            ?>
				          </select> 
                </div> 
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="namaproduk" placeholder="Nama Produk"  class="form-control">
                </div>
                ...
                <div class="form-group">
                  ...
                  SIZE: 1024 X 832(WIDTH X HEIGHT)
