      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form enctype="multipart/form-data" method="post" action="actiondeleteproduk.php">
                <div class="form-group">
                <label>Brand</label><br/>
			          <select name="idProduk" class="form-control" onchange="changeValue(this.value)">
                <option>Pilih</optiom>
				            <?php
                    include "koneksi.php";
                    $query = mysqli_query($koneksi,'SELECT * FROM produk');
                    $jsarray = "var idProduk = new Array();\n";
                    
			              while($ulang=mysqli_fetch_array($query))
				            {
                      echo "<option value=".$ulang['idProduk'].">" .$ulang['namaProduk']."</option>";
                      $jsarray .= "idProduk['". $ulang['idProduk'] ."'] = {idProduk:'" . addslashes($ulang['idProduk']) ."',namaProduk:'" . addslashes($ulang['namaProduk']) . "'};\n";
				            }
				            ?>
				          </select> 
                </div> 
...
function changeValue(id){
    document.getElementById('text').value = idProduk[id].text; 
  }
</script>
</body>
</html>
